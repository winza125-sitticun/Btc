...
class TargetRrTelemetryTests(unittest.TestCase):
    def test_target_rr_summary_counts_each_target_and_no_target(self):
        summary = scanner._summarize_target_rr_opportunities(
            [
                [0.80, 1.20, 1.60],
                [0.90, 1.50, 2.10],
                [1.10, 1.30],
        ...
        self.assertEqual(summary["tp1_ge_1_50"], 0)
        self.assertEqual(summary["tp2_ge_1_50"], 2)
        self.assertEqual(summary["tp3_ge_1_50"], 3)
        self.assertEqual(summary["no_target_ge_1_50"], 1)
    ...
    def test_cycle_logs_target_rr_for_rr_too_low_without_changing_reject_flow(self):
        ...
        self.assertIn(
            "[*] TARGET_RR: samples=1 tp1_ge_1_50=0 tp2_ge_1_50=1 "
            "tp3_ge_1_50=1 no_target_ge_1_50=0",
            rendered,
        )
